...
Revision ID: 5d1071f7acc0
Revises:
Create Date: 2020-05-04 21:37:06.473601
...
def upgrade():
    ...
    op.create_index('agent_type', 'agent', ['type'], unique=False, postgresql_using='hash')
    op.create_index(op.f('ix_agent_created'), 'agent', ['created'], unique=False)
    op.create_index(op.f('ix_agent_updated'), 'agent', ['updated'], unique=False)
    ...
    sa.Column('password', sqlalchemy_utils.types.password.PasswordType(length=64), nullable=True),
    ...
    op.create_index(op.f('ix_device_updated'), 'device', ['updated'], unique=False)
    ...
    sa.Column('transfer_state', teal.db.IntEnum(), nullable=False, comment='State of transfer for a given Lot of devices.\n    '),
    ...
    op.create_index(op.f('ix_lot_created'), 'lot', ['created'], unique=False)
    op.create_index(op.f('ix_lot_updated'), 'lot', ['updated'], unique=False)
    ...
    op.create_index(op.f('ix_proof_created'), 'proof', ['created'], unique=False)
    op.create_index(op.f('ix_proof_updated'), 'proof', ['updated'], unique=False)
    ...
    sa.ForeignKeyConstraint(['parent_id'], ['computer.id'], ),
    sa.ForeignKeyConstraint(['snapshot_id'], ['snapshot.id'], name='snapshot_actions', use_alter=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_action_created'), 'action', ['created'], unique=False)
    op.create_index(op.f('ix_action_updated'), 'action', ['updated'], unique=False)
    ...
    op.create_index('ix_type', 'action', ['type'], unique=False, postgresql_using='hash')
    ...
    op.create_index(op.f('ix_deliverynote_created'), 'deliverynote', ['created'], unique=False)
    op.create_index(op.f('ix_deliverynote_updated'), 'deliverynote', ['updated'], unique=False)
    op.create_table('individual',
    sa.Column('active_org_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['active_org_id'], ['organization.id'], ),
    sa.ForeignKeyConstraint(['id'], ['agent.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['common.user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_index('path_btree', 'path', ['path'], unique=False, postgresql_using='btree')
    op.create_index('path_gist', 'path', ['path'], unique=False, postgresql_using='gist')
    ...
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['proof.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index(op.f('ix_tag_secondary'), 'tag', ['secondary'], unique=False)
    op.create_index(op.f('ix_tag_updated'), 'tag', ['updated'], unique=False)
    op.create_table('action_component',
    sa.Column('device_id', sa.BigInteger(), nullable=False),
    sa.Column('action_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['action_id'], ['action.id'], ),
    sa.ForeignKeyConstraint(['device_id'], ['component.id'], ),
    ...
    op.create_index(op.f('ix_membership_created'), 'membership', ['created'], unique=False)
    op.create_index(op.f('ix_membership_updated'), 'membership', ['updated'], unique=False)
    ...
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['action_with_one_device.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['id'], ['benchmark.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['action_with_one_device.id'], ),
    sa.ForeignKeyConstraint(['rating_id'], ['rate.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['erasure_id'], ['erase_basic.id'], ),
    sa.ForeignKeyConstraint(['id'], ['proof.id'], ),
    ...
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['rate.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('snapshot_request',
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('request', sa.JSON(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['snapshot.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('severity', teal.db.IntEnum(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['erasure_id'], ['erase_basic.id'], ondelete='CASCADE'),
    ...
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['confirms_id'], ['organize.id'], ),
    sa.ForeignKeyConstraint(['id'], ['action.id'], ),
    sa.ForeignKeyConstraint(['price_id'], ['price.id'], ),
    sa.ForeignKeyConstraint(['to_id'], ['agent.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('trade')
    op.drop_table('visual_test')
    op.drop_table('test_trackpad')
    op.drop_table('test_power_adapter')
    op.drop_table('test_keyboard')
    op.drop_table('test_display_hinge')
    op.drop_table('test_data_storage')
    op.drop_table('test_connectivity')
    op.drop_table('test_camera')
    op.drop_table('test_bios')
    op.drop_table('test_audio')
    op.drop_table('stress_test')
    op.drop_table('step')
    op.drop_table('snapshot_request')
    op.drop_table('rate_computer')
    op.drop_table('proof_function')
    op.drop_table('proof_data_wipe')
    op.drop_table('price')
    op.drop_table('measure_battery')
    op.drop_table('benchmark_with_rate')
    op.drop_table('benchmark_data_storage')
    op.drop_table('test')
    op.drop_table('snapshot')
    op.drop_table('rate')
    op.drop_table('live')
    op.drop_table('install')
    op.drop_table('erase_basic')
    op.drop_table('benchmark')
    op.drop_table('sound_card')
    op.drop_table('receive')
    op.drop_table('ram_module')
    op.drop_table('processor')
    op.drop_table('organize')
    op.drop_table('network_adapter')
    op.drop_table('motherboard')
    op.drop_table('migrate')
    op.drop_index(op.f('ix_membership_updated'), table_name='membership')
    op.drop_index(op.f('ix_membership_created'), table_name='membership')
    op.drop_table('membership')
    op.drop_table('graphic_card')
    op.drop_table('display')
    op.drop_table('deallocate')
    op.drop_table('data_storage')
    op.drop_table('battery')
    op.drop_table('allocate')
    op.drop_index('action_one_device_id_index', table_name='action_with_one_device')
    op.drop_table('action_with_one_device')
    op.drop_table('action_device')
    op.drop_table('action_component')
    op.drop_index(op.f('ix_tag_updated'), table_name='tag')
    ...
    op.drop_table('tag')
    op.drop_table('proof_transfer')
    op.drop_table('proof_reuse')
    op.drop_table('proof_recycling')
    op.drop_index('path_gist', table_name='path')
    op.drop_index('path_btree', table_name='path')
    op.drop_index('lot_id_index', table_name='path')
    op.drop_table('path')
    op.drop_table('lot_device')
    ...
    op.drop_index('parent_index', table_name='component')
    op.drop_table('component')
    op.drop_index('ix_type', table_name='action')
    op.drop_index('ix_parent_id', table_name='action')
    op.drop_index('ix_id', table_name='action')
    op.drop_index(op.f('ix_action_updated'), table_name='action')
    op.drop_index(op.f('ix_action_created'), table_name='action')
    op.drop_table('action')
    op.drop_index(op.f('ix_proof_updated'), table_name='proof')
    op.drop_index(op.f('ix_proof_created'), table_name='proof')
    op.drop_table('proof')
    op.drop_table('printer')
    op.drop_table('organization')
    op.drop_table('networking')
    op.drop_table('monitor')
    op.drop_table('mobile')
    op.drop_index(op.f('ix_lot_updated'), table_name='lot')
    op.drop_index(op.f('ix_lot_created'), table_name='lot')
    op.drop_table('lot')
    op.drop_index('tags gist', table_name='device_search')
    op.drop_index('properties gist', table_name='device_search')
    op.drop_table('device_search')
    op.drop_table('computer_accessory')
    op.drop_table('computer')
    op.drop_table('user_inventory', schema='common')
    op.drop_index('type_index', table_name='device')
    op.drop_index(op.f('ix_device_updated'), table_name='device')
    op.drop_index(op.f('ix_device_created'), table_name='device')
    op.drop_index('device_id', table_name='device')
    ...
    op.drop_index(op.f('ix_agent_updated'), table_name='agent')
    op.drop_index(op.f('ix_agent_created'), table_name='agent')
    op.drop_index('agent_type', table_name='agent')
    op.drop_table('agent')
    # ### end Alembic commands ###
